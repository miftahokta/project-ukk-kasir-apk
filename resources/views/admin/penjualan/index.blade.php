                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="text-muted float-end"><a href="/admin/penjualan/print"
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        {{-- <a class="dropdown-item" href="/admin/penjualan/{{$p->id}}/edit/"><i class="mdi mdi-pencil-outline me-1"></i> Edit</a> --}}
                                                        <a class="dropdown-item" href="/admin/penjualan/hapus/{{$p->id}}"><i class="mdi mdi-trash-can-outline me-1"></i> Delete</a>
                                                    </div>
                                                </div>
                                            </td>    
                                            </tr>
