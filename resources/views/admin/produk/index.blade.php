                                    ...
                                    <tbody>
                                        @foreach ($produk as $p)
                                            <tr>
                                                ...
                                                {{-- <td class="text-truncate"><img src="{{ asset($p->gambar) }}" width="70">
                                                </td> --}}
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="produk/edit/{{$p->id}}"><i class="mdi mdi-pencil-outline me-1"></i> Edit</a>
                                                            <a class="dropdown-item" href="produk/hapus/{{$p->id}}"><i class="mdi mdi-trash-can-outline me-1"></i> Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
