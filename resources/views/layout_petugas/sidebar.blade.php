<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="" class="app-brand-link">
            ...
            class="me-3"
            height="36" />
            <span class="app-brand-text demo menu-text fw-semibold ms-0">TOKO OLAHRAGA</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        {{-- <li class="menu-item {{ Request::is('petugas/dashboard*') ? 'active' : '' }}">
            <a href="{{ route('dashboardpetugas') }}" class="menu-link">
        ...
        {{-- <li class="menu-item {{ Request::is('petugas/detailpenjualan*') ? 'active' : '' }}">
            <a href="/" class="menu-link">
                <i class="menu-icon tf-icons mdi mdi-file-document-multiple"></i>
                <div data-i18n="Layouts">Detail Penjualan</div>
            </a>
        </li> --}}
        ...
        <li class="menu-item {{ Request::is('petugas/produk*') ? 'active' : '' }}">
            <a href="{{ route('produkpetugas') }}" class="menu-link">
                ...
                <div data-i18n="Front Pages">Produk</div>
            </a>
        </li>

        <li class="menu-header fw-medium mt-4">
            <span class="menu-header-text">Account &amp; Pages</span>
        </li>
        <!-- Apps -->
        <!-- <li class="menu-item">
            <a href="https://demos.themeselection.com/materio-bootstrap-html-petugas-template/html/vertical-menu-template/app-email.html"
        ...
        <li class="menu-item">
            <a href="https://demos.themeselection.com/materio-bootstrap-html-petugas-template/html/vertical-menu-template/app-chat.html"
                target="_blank" class="menu-link">
        ...
        <li class="menu-item">
            <a href="https://demos.themeselection.com/materio-bootstrap-html-petugas-template/html/vertical-menu-template/app-calendar.html"
                target="_blank" class="menu-link">
        ...
        <li class="menu-item">
            <a href="https://demos.themeselection.com/materio-bootstrap-html-petugas-template/html/vertical-menu-template/app-kanban.html"
                target="_blank" class="menu-link">
        ...
        <!-- Form Validation -->
        <!-- <li class="menu-item">
            <a href="https://demos.themeselection.com/materio-bootstrap-html-petugas-template/html/vertical-menu-template/form-validation.html"
                target="_blank" class="menu-link">
        ...
        <!-- Data Tables -->
        <!-- <li class="menu-item">
            <a href="https://demos.themeselection.com/materio-bootstrap-html-petugas-template/html/vertical-menu-template/tables-datatables-basic.html"
                target="_blank" class="menu-link">
