                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="text-muted float-end"><a href="{{ route('produkpetugas') }}" class="btn btn-outline-dark">Kembali</a></div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('actionprodukpetugas') }}" method="post" enctype="multipart/form-data">
                                @csrf
