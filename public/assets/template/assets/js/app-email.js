...
document.addEventListener("DOMContentLoaded", function() {
    {
        ...
        o && o.forEach(e=>{
            e.addEventListener("click", e=>{
                ...
                t < o.length ? 0 == t ? g.indeterminate = !1 : g.indeterminate = !0 : t == o.length ? (g.indeterminate = !1,
        ...
        L && L.addEventListener("click", e=>{
            o.forEach(e=>{
                ...
                e.querySelector("i").classList.remove("mdi-email-open-outline"),
                e.querySelector("i").classList.add("mdi-email-outline"))
            }
            ),
            g.indeterminate = !1,
            g.checked = !1
        ...
        function a() {
            function e(e) {
                return e.id ? "<div class='d-flex flex-wrap align-items-center lh-1 me-1'><div class='avatar avatar-xs me-2 w-px-20 h-px-20'><img src='" + assetsPath + "img/avatars/" + $(e.element).data("avatar") + "' alt='avatar' class='rounded-circle' /></div>" + e.text + "</div>" : e.text
            }
        ...
        C && C.forEach(e=>{
            e.addEventListener("click", e=>{
                ...
                0 == document.querySelectorAll(".email-list-item").length && q.classList.remove("d-none")) : Helpers._hasClass("email-read", e) ? (e.parentNode.closest("li.email-list-item").classList.add("email-marked-read"),
                Helpers._toggleClass(e, "email-read", "email-unread"),
                Helpers._toggleClass(e.querySelector("i"), "mdi-email-open-outline", "mdi-email-outline")) : Helpers._hasClass("email-unread", e) && (e.parentNode.closest("li.email-list-item").classList.remove("email-marked-read"),
                Helpers._toggleClass(e, "email-read", "email-unread"),
                Helpers._toggleClass(e.querySelector("i"), "mdi-email-open-outline", "mdi-email-outline"))
            }
            )
        }
        )
