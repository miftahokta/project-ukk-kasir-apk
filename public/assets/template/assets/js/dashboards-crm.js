"use strict";
!function() {
    let e, o, t, r, s, i, a = config.colors_label.primary;
    var n = {
        donut: {
      ...
      , l = (i = (isDarkStyle ? (e = config.colors_dark.cardColor,
    ...
    config.colors_dark) : (e = config.colors.cardColor,
    ...
    document.querySelector("#totalSalesChart"))
      ...
      , l = (null !== l && new ApexCharts(l,c).render(),
    ...
    document.querySelector("#salesOverviewChart"))
      ...
      , n = (null !== l && new ApexCharts(l,c).render(),
    document.querySelector("#weeklySalesChart"))
      ...
      , c = (null !== n && new ApexCharts(n,l).render(),
    document.querySelector("#totalGrowthAreaChart"))
      ...
      , l = (null !== c && new ApexCharts(c,n).render(),
    ...
    l && new Cleave(l,{
        ...
        onCreditCardTypeChanged: function(e) {
            document.querySelector(".card-payment-type").innerHTML = "" != e && "unknown" != e ? '<img src="' + assetsPath + "img/icons/payments/" + e + '-cc.png" class="cc-icon-image" height="28"/>' : ""
        }
    }),
    c && new Cleave(c,{
        date: !0,
