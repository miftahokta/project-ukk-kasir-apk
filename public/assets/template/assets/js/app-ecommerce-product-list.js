        ...
        columnDefs: [{
            ...
            render: function(t, e, s, n) {
                var a = s.product_name
                  ...
                  , o = s.product_brand
                  , c = s.image;
                return '<div class="d-flex justify-content-start align-items-center product-name"><div class="avatar-wrapper me-3"><div class="avatar rounded-2 bg-label-secondary">' + (c ? '<img src="' + assetsPath + "img/ecommerce-images/" + c + '" alt="Product-' + i + '" class="rounded-2">' : '<span class="avatar-initial rounded-2 bg-label-' + ["success", "danger", "warning", "info", "dark", "primary", "secondary"][Math.floor(6 * Math.random())] + '">' + (c = (((c = (a = s.product_brand).match(/\b\w/g) || []).shift() || "") + (c.pop() || "")).toUpperCase()) + "</span>") + '</div></div><div class="d-flex flex-column"><span class="text-nowrap text-heading fw-medium">' + a + '</span><small class="text-truncate d-none d-sm-block">' + o + "</small></div></div>"
            }
        }, {
            targets: 3,
            ...
            render: function(t, e, s, n) {
                ...
                }[o[s].title] + '<span class="d-none">' + o[s].title + "</span></span>"
            }
        }, {
            targets: 5,
            render: function(t, e, s, n) {
            ...
            render: function(t, e, s, n) {
                s = s.status;
                return '<span class="badge rounded-pill ' + a[s].class + '" text-capitalized>' + a[s].title + "</span>"
            }
        }, {
            targets: -1,
            title: "Actions",
        ...
        initComplete: function() {
            this.api().columns(-2).every(function() {
                ...
                e.data().unique().sort().each(function(t, e) {
                    s.append('<option value="' + a[t].title + '">' + a[t].title + "</option>")
                })
            }),
            ...
            this.api().columns(4).every(function() {
                ...
                e.data().unique().sort().each(function(t, e) {
                    s.append('<option value="' + o[t].title + '">' + c[t].title + "</option>")
                })
            })
        }
    }),
